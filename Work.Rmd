...
toblers_hiking_function <- function(slope_angle, max_speed = 6) {
...
```{r}
dummydata <- data.frame(slope_angle = seq(-60, 60, by = .1),
                        speed = toblers_hiking_function(dummydata$slope_angle))
